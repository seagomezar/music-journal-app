...
void main() {
  ...
  setUpAll(() async {
    ...
    samplePdfPath = await storage.importPdf(
      sourceFile.path,
  ...
  group('iPad Fullscreen UI Suite', () {
    ...
    testWidgets('4a. Repertoire Portrait', (tester) async {
      ...
      addTearDown(tester.view.resetPhysicalSize);
      await tester.pumpWidget(
        _wrapWithProviders(child: const RepertoireView()),
      );
    ...
    testWidgets('7a. Calendar / History Portrait', (tester) async {
      ...
      addTearDown(tester.view.resetPhysicalSize);
      await tester.pumpWidget(
        _wrapWithProviders(child: const CalendarHistoryView()),
      );
