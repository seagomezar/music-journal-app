...
class LocalizationProvider with ChangeNotifier {
  ...
  static const Map<String, String> _en = {
    ...
    'recording_count_one_format': '{} recording saved in this session',
    ...
    'folder_piece_count': '{} pieces',
    'folder_empty_title': 'This folder is empty.',
    'folder_empty_desc':
        'Add a repertoire piece here or move one from another folder.',
    ...
    'no_music_sheet_attached': 'No music sheet attached',
    'remove_music_sheet': 'Remove music sheet',
    'choose_from_repertoire': 'Choose from repertoire',
    'import_pdf_from_device': 'Import PDF from device',
    'no_repertoire_pdfs_available':
        'Add a PDF to your repertoire before selecting one.',
    'score_unavailable': 'Music sheet unavailable',
    ...
    'invalid_folder_name': 'Enter a folder name of 100 characters or fewer.',
    'duplicate_folder_name': 'A folder with this name already exists.',
    'folder_save_error': 'The folder could not be saved.',
    'folder_delete_error': 'The folder could not be deleted.',
    'delete_folder_title': 'Delete folder?',
    'delete_folder_confirm':
        'The pieces in this folder will be moved to Unfiled. Their PDFs and progress will be preserved.',
    'delete_piece_title': 'Delete repertoire piece?',
    'delete_piece_confirm':
        'This removes the piece and its app-managed PDF, and detaches it from exercises. This cannot be undone.',
    'settings': 'Settings',
    ...
    'delete_session_confirm':
        'This permanently removes the session and all of its recordings.',
    ...
    'clear_annotations_title': 'Clear this page?',
    'clear_annotations_confirm':
        'This permanently removes every annotation from the current page.',
    'clear': 'Clear',
    'annotations_saved_automatically':
        'Annotations are saved automatically for this score.',
    'annotations_load_error':
        'Saved annotations could not be loaded for this score.',
    'annotations_save_error':
        'Annotations could not be saved. Your latest changes may be lost.',
    'export_annotated_pdf': 'Export annotated PDF',
    'annotated_pdf_exported': 'The annotated PDF was exported.',
    'annotated_pdf_export_error': 'The annotated PDF could not be exported.',
    'score_display_options': 'Score display options',
    'performance_mode': 'Performance mode',
    'exit_performance': 'Exit performance mode',
    'touch_lock': 'Lock touch page turns',
    ...
    'fit_page': 'Fit page',
    'fit_width': 'Fit width',
    'first_page_on_right': 'Place the first page on the right',
    ...
    'speed': 'Speed',
    'duration': 'Duration',
    'start_page_one': 'Start at page 1',
    'start_auto_scroll': 'Start auto-scroll',
    'pause_auto_scroll': 'Pause auto-scroll',
    'page': 'Page',
    'pdf_missing':
    ...
    'keep_screen_awake_subtitle':
        'Prevents automatic screen lock while the practice timer is running.',
  ...
  static const Map<String, String> _es = {
    ...
    'recording_count_one_format': '{} grabación guardada en esta sesión',
    ...
    'folder_piece_count': '{} piezas',
    'folder_empty_title': 'Esta carpeta está vacía.',
    'folder_empty_desc': 'Añade una pieza aquí o mueve una desde otra carpeta.',
    ...
    'music_sheet': 'Partitura',
    'no_music_sheet_attached': 'Sin partitura adjunta',
    'remove_music_sheet': 'Quitar partitura',
    'choose_from_repertoire': 'Elegir del repertorio',
    'import_pdf_from_device': 'Importar PDF del dispositivo',
    'no_repertoire_pdfs_available':
        'Agrega un PDF al repertorio antes de seleccionar uno.',
    'score_unavailable': 'Partitura no disponible',
    'recording_web_session_only':
    ...
    'invalid_folder_name':
        'Ingresa un nombre de carpeta de máximo 100 caracteres.',
    'duplicate_folder_name': 'Ya existe una carpeta con este nombre.',
    'folder_save_error': 'No se pudo guardar la carpeta.',
    'folder_delete_error': 'No se pudo eliminar la carpeta.',
    'delete_folder_title': '¿Eliminar carpeta?',
    'delete_folder_confirm':
        'Las piezas de esta carpeta se moverán a Sin archivar. Sus PDF y su progreso se conservarán.',
    'delete_piece_title': '¿Eliminar pieza del repertorio?',
    'delete_piece_confirm':
        'Esto elimina la pieza y su PDF administrado por la app, y la desvincula de los ejercicios. No se puede deshacer.',
    'settings': 'Ajustes',
    ...
    'delete_session_confirm':
        'Esto elimina permanentemente la sesión y todas sus grabaciones.',
    ...
    'clear_annotations_title': '¿Borrar esta página?',
    'clear_annotations_confirm':
        'Esto elimina permanentemente todas las anotaciones de la página actual.',
    'clear': 'Borrar',
    'annotations_saved_automatically':
        'Las anotaciones se guardan automáticamente para esta partitura.',
    'annotations_load_error':
        'No se pudieron cargar las anotaciones guardadas de esta partitura.',
    'annotations_save_error':
        'No se pudieron guardar las anotaciones. Es posible que se pierdan los últimos cambios.',
    'export_annotated_pdf': 'Exportar PDF anotado',
    'annotated_pdf_exported': 'Se exportó el PDF anotado.',
    'annotated_pdf_export_error': 'No se pudo exportar el PDF anotado.',
    'score_display_options': 'Opciones de visualización',
    'performance_mode': 'Modo de presentación',
    'exit_performance': 'Salir del modo de presentación',
    'touch_lock': 'Bloquear cambios de página táctiles',
    'auto_scroll': 'Desplazamiento automático',
    'page_layout': 'Diseño de página',
    'single_page': 'Una página',
    'continuous': 'Continuo',
    'half_page': 'Media página',
    'two_pages': 'Dos páginas',
    'fit_page': 'Ajustar página',
    'fit_width': 'Ajustar ancho',
    'first_page_on_right': 'Colocar la primera página a la derecha',
    'orientation': 'Orientación',
    'automatic': 'Automática',
    'portrait': 'Vertical',
    'landscape': 'Horizontal',
    'score_colors': 'Colores de la partitura',
    'normal': 'Normal',
    'sepia': 'Sepia',
    'inverted': 'Invertido',
    'brightness': 'Brillo',
    'speed': 'Velocidad',
    'duration': 'Duración',
    'start_page_one': 'Comenzar en la página 1',
    'start_auto_scroll': 'Iniciar desplazamiento',
    'pause_auto_scroll': 'Pausar desplazamiento',
    'page': 'Página',
    'pdf_missing':
    ...
    'keep_screen_awake_subtitle':
        'Evita el bloqueo automático mientras el temporizador de práctica esté en marcha.',
...
extension LocalizationExtension on BuildContext {
  ...
  String translateRecordingCount(int count) {
    return translate(
      count == 1 ? 'recording_count_one_format' : 'recording_count_format',
      [count.toString()],
    );
  }
}
