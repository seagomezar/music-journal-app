...
const _surfaceKey = ValueKey('ipad_surface');
final _targetDir = Directory('/Users/sebas/Desktop/AppStoreScreenshots/ipad');
...
Widget _wrapWithProviders({
  ...
  return MultiProvider(
    ...
    child: MaterialApp(
      ...
      home: Scaffold(
        body: RepaintBoundary(key: _surfaceKey, child: child),
      ),
    ),
  );
}
...
void main() {
  ...
  setUpAll(() async {
    ...
    tempDir = await Directory.systemTemp.createTemp('flute_ipad_real_');
  ...
  group('iPad 13" Real Native Screenshots (2048x2732)', () {
